...
import type { ModelMetadata, UniqueModelIntricacies } from "./model-metadata.js";
...
function getModelMetadataForAgent(fallback: string[]): Pick<ModelMetadata,
  | 'context_window_size'
  | 'recommended_top_k'
  | 'recommended_top_p'
 ...
 */
export function getOhMyOpenCodeAgents(): Record<string, AgentMetadata> {
 ...
 */
export function getTaskMasterAgents(): Record<string, AgentMetadata> {
 ...
 */
export function getAllFallbackChains(): Record<string, string[]> {
 ...
 */
export function getCategoryChains(): Record<string, string[]> {
