...
export type UniqueModelIntricacies = z.infer<
  typeof UniqueModelIntricaciesSchema
>;
...
export const validateModelMetadata = (metadata: unknown): ModelMetadata => {
  try {
...
export const validatePartialModelMetadata = (
  metadata: unknown
...
export const MODEL_METADATA_REGISTRY: Record<string, ModelMetadata> = {
  "gpt-4o": {
    ...
    prompting_style_guidelines:
      "Use clear, direct instructions. System messages work well for role definition. Break complex tasks into steps. JSON mode available for structured output.",
  ...
  "claude-3.5-sonnet": {
    ...
    recommended_top_p: 0.9,
    prompting_style_guidelines:
      "Use detailed, structured prompts with XML tags for clarity. Chain-of-thought prompting improves reasoning. Provide examples for complex tasks. Explicitly state formatting requirements.",
    unique_model_intricacies: {
      common_pitfalls: [
  ...
  "llama-3.1-70b": {
    ...
    prompting_style_guidelines:
      "Use explicit, concise prompts. Chat format with special tokens recommended. Few-shot examples improve performance. Be direct about output format requirements.",
    unique_model_intricacies: {
      common_pitfalls: [
  ...
  "gemini-1.5-pro": {
    ...
    recommended_top_p: 0.9,
    prompting_style_guidelines:
      "Leverage massive context - include all relevant documents. Use clear, structured prompts. Few-shot examples work well. Can handle long-context queries across multiple files.",
    unique_model_intricacies: {
      common_pitfalls: [
  ...
  "qwen3-coder": {
    ...
    recommended_top_p: 0.95,
    prompting_style_guidelines:
      "Provide explicit coding requirements, language specifications, and constraints. Include test cases and expected behavior. Use code-first prompts with clear problem statements.",
    unique_model_intricacies: {
      common_pitfalls: [
