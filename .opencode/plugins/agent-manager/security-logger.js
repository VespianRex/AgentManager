 ...
 */
export const maskSensitiveData = (data, seen = new WeakSet()) => {
    // Handle primitives
    ...
    for (const [key, value] of Object.entries(data)) {
        ...
        const isSensitiveKey = SENSITIVE_ENV_VARS.has(upperKey) ||
...
const serializeDetails = (value, seen = new WeakSet()) => {
...
const initializedDefaultLogPaths = new Set();
export function setLogPath(newPath) {
...
export async function logSecurityEvent(event, severity, details) {
    ...
    try {
        ...
        const entry = {
            ...
            ...(details !== undefined
                ? { details: maskSensitiveData(serializeDetails(details)) }
                : {}),
        };
